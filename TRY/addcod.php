        ...
        <div class="form-group">
            ...
            <form method="post" action="">
                <div class="field_wrapper">
                    <div>
                        <input type="text" name="field_name[]" class="form-control-lg" value="" placeholder="Enter CO" />
                        <input type="text" name="field_name[]" value="" class="form-control-lg" placeholder="Enter CO" />
